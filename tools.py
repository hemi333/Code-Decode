...
SANDBOX = Path(__file__).resolve().parent / "fixtures"
...
LIST_FILES_TOOL = {
    ...
    "description": (
        # TODO: 설명을 쓰세요.
        #
        # 이 도구가 없으면 모델은 어떤 파일이 있는지 알 수 없습니다.
        # 그래서 "폴더에서 가장 긴 파일" 같은 질문에는 이걸 먼저 불러야 합니다.
        # 그 사실이 설명에 드러나야 모델이 순서를 지킵니다.
        ""
    ),
    "input_schema": {
        "type": "object",
        "properties": {
            # TODO: pattern 파라미터. glob 패턴 문자열이고, 선택 사항입니다.
            #       기본값을 스키마에 적을 수는 없으니 description 에 쓰세요.
        },
        "required": [],
    },
}
...
def list_files(pattern: str = "*") -> dict:
    ...
    """
    # TODO: 구현하세요.
    raise NotImplementedError("list_files 를 구현하세요")
...
def read_file(name: str) -> dict:
    ...
    """
    # TODO: 구현하세요.
    raise NotImplementedError("read_file 을 구현하세요")
